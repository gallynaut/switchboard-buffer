...
const runOracle = async ({
    ...
    const aggregatorAccount = await AggregatorAccount.create(switchboard.program, {
    ...
    const aggregatorPermission = await PermissionAccount.create(switchboard.program, {
        authority: wallet.publicKey,
        granter: queueAccount.publicKey,
